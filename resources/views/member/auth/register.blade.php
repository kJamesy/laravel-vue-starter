            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form method="POST" action="{{ route('member.auth.store_registration') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' form-control-danger' : '' }}" name="phone" value="{{ old('phone') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a class="btn btn-link" href="{{ route('member.auth.show_login') }}">Login</a>
                                </div>
                            </div>
                        </form>
                    </div>
